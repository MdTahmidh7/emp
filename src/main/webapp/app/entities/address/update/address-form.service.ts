...
type AddressFormGroupContent = {
  ...
  roadNo: FormControl<IAddress['roadNo']>;
  block: FormControl<IAddress['block']>;
  section: FormControl<IAddress['section']>;
  division: FormControl<IAddress['division']>;
};
...
export class AddressFormService {
  createAddressFormGroup(address: AddressFormGroupInput = { id: null }): AddressFormGroup {
    ...
    return new FormGroup<AddressFormGroupContent>({
      ...
      roadNo: new FormControl(addressRawValue.roadNo),
      block: new FormControl(addressRawValue.block),
      section: new FormControl(addressRawValue.section),
      division: new FormControl(addressRawValue.division),
    });
  }
