      ...
      it('should create a new form with FormControl', () => {
        ...
        expect(formGroup.controls).toEqual(
          expect.objectContaining({
            ...
            empMobile: expect.any(Object),
            empBirthDate: expect.any(Object),
            empGender: expect.any(Object),
            empPersonalBusiness: expect.any(Object),
            empMaritalStatus: expect.any(Object),
            empExperience: expect.any(Object),
            empNationality: expect.any(Object),
            employeeAddress: expect.any(Object),
          })
        );
      });
